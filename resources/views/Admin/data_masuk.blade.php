                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="mt-0 header-title">Data Pembelian Pakan</h4>

                                        <!-- Form untuk mengirim data ke controller -->
                                        <form action="{{ route('store.pembelian_pakan') }}" method="POST">
                                            @csrf

                                            <!-- Input untuk nama pakan -->
                                            <div class="form-group row">
                                                <label for="nama_pakan" class="col-sm-2 col-form-label">Nama
                                                    Pakan</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" id="nama_pakan"
                                                        name="nama_pakan" placeholder="Masukkan Nama Pakan"
                                                        value="{{ old('nama_pakan') }}" required>
                                                </div>
                                            </div>
                                            ...
                                            <!-- Pilih Kolam berdasarkan nama kolam -->
                                            <div class="form-group row">
                                                <label for="nama_kolam" class="col-sm-2 col-form-label">Kolam</label>
                                                <div class="col-sm-10">
                                            ...
                                            <!-- Input untuk jumlah pembelian -->
                                            <div class="form-group row">
                                                <label for="jumlah_pembelian" class="col-sm-2 col-form-label">Jumlah
                                                    Pembelian</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="number" id="jumlah_pembelian"
                                                        name="jumlah_pembelian" placeholder="Masukkan Jumlah Pembelian"
