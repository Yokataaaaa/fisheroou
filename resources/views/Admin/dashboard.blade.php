...
<head>
    ...
    <title>FisheerLog - Dashboard</title>
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        ...
                                        <p class="notify-details"><b>Pesan baru</b><small class="text-muted">Seseorang
                                                memperbarui data masuk</small></p>
                                    </a>
                                    <!-- All-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                                        View All
                ...
                <div class="page-content-wrapper ">
                    <div class="container-fluid">
                        ...
                        <div class="dashboard-content">
                            <h1>Welcome to your dashboard, Fisheero</h1>
                            <div class="card">
                                <i class="fas fa-user -cog"></i>
                                <h3>Manage admin</h3>
                                <p>Create your admin management to create your distribution!</p>
                            </div>
                            <div class="card">
                                <i class="fas fa-database"></i>
                                <h3>Add data</h3>
                                <p>Create complete product data content for users</p>
                            </div>
                        </div>
                    </div><!-- container -->
